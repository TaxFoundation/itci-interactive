...
const MailChimp = ({ callback }) => {
  ...
  const submit = e => {
    ...
    axios
      .post(
        '//TaxFoundation.us1.list-manage.com/subscribe/post-json?u=fefb55dc846b4d629857464f8&amp;id=6c6b782bd7&SIGNUP=Blog',
        {
          FNAME: name,
          EMAIL: email,
          COUNTRY: country,
      ...
      >
        ...
        >
          <div className="content__gdpr">
            ...
            >
              <label className="checkbox subfield" htmlFor="gdpr_37">
                <input
                  type="checkbox"
                  id="gdpr_37"
                  name="gdpr[37]"
